...
We utilized the LAVA code for calculating the DNP surface energys for these elements using the DNPs and LAMMPs do to the code's ease of use for this appliation.
